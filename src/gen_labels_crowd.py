...
if __name__ == '__main__':
    data_val = '/root/data/FairMOT/CrowHuman/images/val'
    label_val = '/root/data/FairMOT/CrowHuman/labels_with_ids/val/'
    ann_val = '/root/data/FairMOT/CrowHuman/annotation_val.odgt'
    data_train = '/root/data/FairMOT/CrowHuman/images/train'
    label_train = '/root/data/FairMOT/CrowHuman/labels_with_ids/train'
    ann_train = '/root/data/FairMOT/CrowHuman/annotation_train.odgt'
